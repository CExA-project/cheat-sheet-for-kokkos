...
\begin{tblr}[theme=kokkostable]{llX}
    ...
    \mintinline{text}{-DKokkos_ARCH_AMD_GFX942_APU=ON} & \adjustbox{scale={0.85}{1}}{GFX942 APU} & MI300A \\
    ...
    \mintinline{text}{-DKokkos_ARCH_AMD_GFX1103=ON} & GFX1103 & Ryzen 8000G, Radeon 740M, \adjustbox{scale={0.75}{1}}{760M, 780M, 880M, 980M} \\
