...
\begin{tblr}[theme=kokkostable]{llX}
    ...
    \mintinline{text}{-DKokkos_ARCH_INTEL_PVC=ON} & Xe-HPC & GPU Max (Ponte Vecchio) \\
    \mintinline{text}{-DKokkos_ARCH_INTEL_XEHP=ON} & Xe-HP & \\
    \mintinline{text}{-DKokkos_ARCH_INTEL_DG2=ON} & DG2 & Intel Flex, Intel Arc \\
    \mintinline{text}{-DKokkos_ARCH_INTEL_DG1=ON} & DG1 & Iris Xe MAX \\
    \mintinline{text}{-DKokkos_ARCH_INTEL_GEN12LP=ON} & Gen12LP & Intel UHD Graphics 770 \\
    \mintinline{text}{-DKokkos_ARCH_INTEL_GEN11=ON} & Gen11 & Intel UHD Graphics \\
\end{tblr}
}
